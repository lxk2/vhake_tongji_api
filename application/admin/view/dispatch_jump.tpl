...
<head>
    ...
    <title>跳转提示 | {:config('web_site_title')} - VhakeAdmin</title>
...
<div class="content pulldown text-muted text-center">
    极简 · 极速 · 极致<br>
    Vhake，让开发更简单！<br>
    由 <a class="link-effect" href="http://www.vhake.com">VhakeAdmin</a> 强力驱动 <a class="link-effect" href="http://www.vhake.com">卓锐软件</a> 倾情奉献
</div>
<!-- END Error Footer -->
