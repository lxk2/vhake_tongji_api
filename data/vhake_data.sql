/*
 ...
 Source Database       : vhake_data

 Target Server Type    : MySQL
 Target Server Version : 50638
 File Encoding         : utf-8

 Date: 01/17/2019 11:09:07 AM
*/
...
-- ----------------------------
--  Table structure for `vhake_admin_access`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_access`;
CREATE TABLE `vhake_admin_access` (
...
-- ----------------------------
--  Table structure for `vhake_admin_action`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_action`;
CREATE TABLE `vhake_admin_action` (
...
-- ----------------------------
--  Table structure for `vhake_admin_config`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_config`;
CREATE TABLE `vhake_admin_config` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `vhake_admin_hook_plugin`
-- ----------------------------
BEGIN;
INSERT INTO `vhake_admin_hook_plugin` VALUES ('1', 'admin_index', 'SystemInfo', '1477757503', '1477757503', '1', '1'), ('2', 'admin_index', 'DevTeam', '1477755780', '1477755780', '2', '1'), ('3', 'upload_attachment', 'QiNiu', '1546858078', '1546858078', '100', '1');
COMMIT;

-- ----------------------------
--  Table structure for `vhake_admin_icon`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_icon`;
CREATE TABLE `vhake_admin_icon` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `vhake_admin_icon_list`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_icon_list`;
CREATE TABLE `vhake_admin_icon_list` (
...
-- ----------------------------
--  Table structure for `vhake_admin_log`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_log`;
CREATE TABLE `vhake_admin_log` (
...
-- ----------------------------
--  Records of `vhake_admin_log`
-- ----------------------------
BEGIN;
INSERT INTO `vhake_admin_log` VALUES ('1', '2', '1', '0', 'admin_user', '1', '超级管理员 编辑了用户：超级管理员', '1', '1546857401'), ('2', '42', '1', '0', 'admin_config', '0', '超级管理员 更新了系统设置：分组(upload)', '1', '1546858137');
COMMIT;

-- ----------------------------
--  Table structure for `vhake_admin_menu`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_menu`;
CREATE TABLE `vhake_admin_menu` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `vhake_admin_module`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_module`;
CREATE TABLE `vhake_admin_module` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `vhake_admin_module`
-- ----------------------------
BEGIN;
INSERT INTO `vhake_admin_module` VALUES ('1', 'admin', '系统', 'fa fa-fw fa-gear', '系统模块，VhakeAdmin的核心模块', 'VhakeAdmin', 'http://www.VhakeAdmin.com', '', '', '1.0.0', 'admin.VhakeAdmin.module', '1', '1468204902', '1468204902', '100', '1'), ('2', 'user', '用户', 'fa fa-fw fa-user', '用户模块，VhakeAdmin自带模块', 'VhakeAdmin', 'http://www.VhakeAdmin.com', '', '', '1.0.0', 'user.VhakeAdmin.module', '1', '1468204902', '1468204902', '100', '1');
COMMIT;

-- ----------------------------
--  Table structure for `vhake_admin_packet`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_packet`;
CREATE TABLE `vhake_admin_packet` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `vhake_admin_plugin`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_plugin`;
CREATE TABLE `vhake_admin_plugin` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `vhake_admin_plugin`
-- ----------------------------
BEGIN;
INSERT INTO `vhake_admin_plugin` VALUES ('1', 'SystemInfo', '系统环境信息', 'fa fa-fw fa-info-circle', '在后台首页显示服务器信息', 'Vhake', 'http://www.caiweiming.com', '{\"display\":\"1\",\"width\":\"6\"}', '1.0.0', 'system_info.ming.plugin', '0', '1477757503', '1477757503', '100', '1'), ('2', 'DevTeam', '开发团队成员信息', 'fa fa-fw fa-users', '开发团队成员信息', 'Vhake', 'http://www.caiweiming.com', '{\"display\":\"1\",\"width\":\"6\"}', '1.0.0', 'dev_team.ming.plugin', '0', '1477755780', '1477755780', '100', '1'), ('3', 'QiNiu', '七牛上传插件', 'fa fa-fw fa-upload', '仅支持VhakePhp1.0.6以上版本，安装后，需将【<a href=\"/admin.php/admin/system/index/group/upload.html\">上传驱动</a>】将其设置为“七牛云”。在附件管理中删除文件，并不会同时删除七牛云上的文件。', 'Vhake', 'http://www.vhake.com', '{\"__token__\":\"984da7845463123c6c0d0737b282c8e9\",\"ak\":\"rCdFT1tACyHNjgELAE-AGEdOpywb1xakSD0xWe41\",\"sk\":\"UhPJ-lSM-mLu9SPozqrbxM1dzKlB2S_iNKrCdm_6\",\"bucket\":\"www-vhake\",\"domain\":\"http:\\/\\/images.vhake.com\\/\"}', '1.0.3', 'qi_niu.ming.plugin', '0', '1546858078', '1546858078', '100', '1');
COMMIT;

-- ----------------------------
--  Table structure for `vhake_admin_role`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_role`;
CREATE TABLE `vhake_admin_role` (
...
-- ----------------------------
--  Records of `vhake_admin_role`
-- ----------------------------
BEGIN;
INSERT INTO `vhake_admin_role` VALUES ('1', '0', '超级管理员', '系统默认创建的角色，拥有最高权限', '', '0', '1476270000', '1468117612', '1', '1', '0');
COMMIT;

-- ----------------------------
--  Table structure for `vhake_admin_user`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_admin_user`;
CREATE TABLE `vhake_admin_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `vhake_admin_user`
-- ----------------------------
BEGIN;
INSERT INTO `vhake_admin_user` VALUES ('1', 'admin', '超级管理员', '$2y$10$qcgHwYh5EiVdOBZ4aQ14YeljN02mmpjL.0zXH5EdNMHwoSfo7/cSW', '', '0', '', '0', '0', '0.00', '0', '1', '0', '0', '1476065410', '1547107796', '1547107795', '0', '100', '1');
COMMIT;

-- ----------------------------
--  Table structure for `vhake_users`
-- ----------------------------
DROP TABLE IF EXISTS `vhake_users`;
CREATE TABLE `vhake_users` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(32) NOT NULL DEFAULT '' COMMENT '用户名',
  `nickname` varchar(32) NOT NULL DEFAULT '' COMMENT '昵称',
  `password` varchar(96) NOT NULL DEFAULT '' COMMENT '密码',
  ...
  `sort` int(11) NOT NULL DEFAULT '100' COMMENT '排序',
  `status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '状态：0禁用，1启用',
  `info_bind` tinyint(3) NOT NULL DEFAULT '0' COMMENT '是否绑定用户昵称和头像',
  `gender` varchar(20) NOT NULL DEFAULT '' COMMENT '性别',
  `user_key` varchar(20) NOT NULL COMMENT '用户唯一编码',
  `bind_auth` tinyint(3) NOT NULL DEFAULT '0' COMMENT '是否绑定个人认证',
  `small_openid` varchar(60) NOT NULL DEFAULT '',
